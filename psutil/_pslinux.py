...
from ._pslinux_common import Process as BaseProcess
from ._pslinux_common import CLOCK_TICKS
from ._pslinux_common import PAGESIZE
from ._pslinux_common import readlink
from ._pslinux_common import wrap_exceptions
...
boot_time = _pslinux_common.boot_time
...
cpu_count_logical = _pslinux_common.cpu_count_logical
cpu_count_physical = _pslinux_common.cpu_count_physical
cpu_stats = _pslinux_common.cpu_stats
...
pids = _pslinux_common.pids
pid_exists = _pslinux_common.pid_exists
...
class Process(BaseProcess):
    ...
    def oneshot_enter(self):
        super(Process, self).oneshot_enter()
    ...
    if HAS_SMAPS:
        ...
        memory_full_info = BaseProcess.memory_info
